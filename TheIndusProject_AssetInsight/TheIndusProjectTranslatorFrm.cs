...
namespace TheIndusProject.AssetInsight
{
    ...
    /// </summary>
    public partial class TheIndusProjectTranslatorFrm : Form
    {
        #region Constructor

            /// <summary>
            /// Initializes a new instance of the <see cref="TheIndusProjectTranslatorFrm"/> class.
            /// </summary>
            public TheIndusProjectTranslatorFrm()
            {
                InitializeComponent();
            }
        ...
        #region Form event handlers
            ...
            /// <summary>
            /// Handles the Load event of the TheIndusProjectTranslatorFrm control.
            /// </summary>
            /// <param name="sender">The source of the event.</param>
            /// <param name="e">The <see cref="System.EventArgs"/> instance containing the event data.</param>
            private void TheIndusProjectTranslatorFrm_Load
                (object sender,
                 EventArgs e)
            {
                this._comboFrom.Items.AddRange (Translator.Languages.ToArray());
                this._comboTo.Items.AddRange (Translator.Languages.ToArray());
                this._comboFrom.SelectedItem = "Hindi";
                this._comboTo.SelectedItem = "Telugu";
            }
